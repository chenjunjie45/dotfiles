...
---
-- Insert 模式
vim.keymap.set("i", "<C-a>", "<C-o>^", { desc = "Go to Line Start (Insert)" })
vim.keymap.set("i", "<C-e>", "<C-o>$", { desc = "Go to Line End (Insert)" })
...
if vim.fn.executable("lazygit") == 1 then
  ...
  map("n", "<c-g>", function() Snacks.lazygit() end, { desc = "Lazygit (cwd)" })
end
